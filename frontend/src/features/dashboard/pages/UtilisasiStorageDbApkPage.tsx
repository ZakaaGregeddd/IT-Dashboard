...
export const UtilisasiStorageDbApkPage: React.FC = () => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      console.error('Failed to delete Storage DB data:', error);
      ...
      <div className="flex flex-col gap-5 w-full">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden w-full">
          <div className="p-4 border-b border-slate-100 flex flex-col gap-2 bg-white">
            <h3 className="text-xs font-semibold text-slate-800">Performa Year to Date (YTD) - Rata-rata Utilisasi Storage Database</h3>
