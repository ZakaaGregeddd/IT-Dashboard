...
export const UtilisasiCpuAplikasiPage: React.FC = () => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      console.error('Failed to delete CPU App data:', error);
  ...
  return (
    <div className="w-full flex-1 p-4 md:p-6 flex flex-col gap-6 overflow-y-auto bg-slate-50 relative">
      ...
      <div className="flex flex-col gap-4">
        <div>
          <h2 className="text-xl font-bold text-slate-800">CPU</h2>
        </div>
      ...
      <div className="flex flex-col gap-5 w-full">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden w-full">
          <div className="p-4 border-b border-slate-100 flex flex-col gap-2 bg-white">
            <h3 className="text-xs font-semibold text-slate-800">Performa Year to Date (YTD) - Rata-rata Utilisasi CPU Aplikasi</h3>
