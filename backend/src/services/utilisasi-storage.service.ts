    ...
    if (!master) {
      ...
      if (latestMaster) {
        const details = latestMaster.detail_utilisasi_storage.map(d => ({
          ...
          capacity_tb: Number(d.capacity_tb) || 0,
          utilisasi_tb: Number(d.utilisasi_tb) || 0,
          free_tb: Number(d.free_tb) || 0,
        ...
        return {
          ...
          total_kapasitas: Number(latestMaster.total_kapasitas) || 0,
          total_utilisasi: Number(latestMaster.total_utilisasi) || 0,
          total_free: Number(latestMaster.total_free) || 0,
